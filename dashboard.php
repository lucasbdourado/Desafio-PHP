    ...
    <div class="dashboard">
        <main>
            ...
            <tr>
                ...
                <td class="elmnt"><a class="btn green" href="vizualizar.php?cod=<?php echo $display['cod']; ?>">Vizualizar</a><a class="btn orange" href="editar.php?cod=<?php echo $display['cod']; ?>">Editar</a><a href="#" class="btn red" onclick="excluir('<?php echo $display['cod'];?>');">Excluir</a></td>
            </tr>
            <?php
                }
            ?>
